...
! function(t) {
    ...
    f.ui = f.ui || {}, f.ui.version = "1.12.0";
    var o, i = 0,
        h = Array.prototype.slice;
    f.cleanData = (o = f.cleanData, function(t) {
        var e, i, s;
        ...
        return e || (e = i, i = f.Widget), f.isArray(e) && (e = f.extend.apply(null, [{}].concat(e))), f.expr[":"][a.toLowerCase()] = function(t) {
            return !!f.data(t, a)
        }, f[h] = f[h] || {}, s = f[h][t], o = f[h][t] = function(t, e) {
            return this._createWidget ? void(arguments.length && this._createWidget(t, e)) : new o(t, e)
        }, f.extend(o, s, {
            version: e.version,
            _proto: f.extend({}, e),
            _childConstructors: []
        }), (n = new i).options = f.widget.extend({}, n.options), f.each(e, function(e, n) {
            return f.isFunction(n) ? void(r[e] = function() {
                function s() {
            ...
            var i = e.prototype;
            f.widget(i.namespace + "." + i.widgetName, o, e._proto)
        }), delete s._childConstructors) : i._childConstructors.push(o), f.widget.bridge(t, o), o
    }, f.widget.extend = function(t) {
        for (var e, i, s = h.call(arguments, 1), o = 0, n = s.length; o < n; o++)
            for (e in s[o]) i = s[o][e], s[o].hasOwnProperty(e) && void 0 !== i && (t[e] = f.isPlainObject(i) ? f.isPlainObject(t[e]) ? f.widget.extend({}, t[e], i) : f.widget.extend({}, i) : i);
        return t
    }, f.widget.bridge = function(n, e) {
        ...
        f.fn[n] = function(i) {
            ...
            return t ? this.each(function() {
                ...
                return "instance" === i ? (o = e, !1) : e ? f.isFunction(e[i]) && "_" !== i.charAt(0) ? (t = e[i].apply(e, s)) !== e && void 0 !== t ? (o = t && t.jquery ? o.pushStack(t.get()) : t, !1) : void 0 : f.error("no such method '" + i + "' for " + n + " widget instance") : f.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : (s.length && (i = f.widget.extend.apply(null, [i].concat(s))), this.each(function() {
                var t = f.data(this, r);
        ...
        option: function(t, e) {
            ...
            if ("string" == typeof t)
                if (n = {}, t = (i = t.split(".")).shift(), i.length) {
                    for (s = n[t] = f.widget.extend({}, this.options[t]), o = 0; i.length - 1 > o; o++) s[i[o]] = s[i[o]] || {}, s = s[i[o]];
        ...
        _classes: function(o) {
            function t(t, e) {
                var i, s;
                for (s = 0; t.length > s; s++) i = r.classesElementLookup[t[s]] || f(), i = o.add ? f(f.unique(i.get().concat(o.element.get()))) : f(i.not(o.element).get()), r.classesElementLookup[t[s]] = i, n.push(t[s]), e && o.classes[t[s]] && n.push(o.classes[t[s]])
            }
            var n = [],
                r = this;
            return (o = f.extend({
        ...
        _on: function(r, h, t) {
            var a, l = this;
            "boolean" != typeof r && (t = h, h = r, r = !1), t ? (h = a = f(h), this.bindings = this.bindings.add(h)) : (t = h, h = this.element, a = this.widget()), f.each(t, function(t, e) {
                function i() {
                    return r || !0 !== l.options.disabled && !f(this).hasClass("ui-state-disabled") ? ("string" == typeof e ? l[e] : e).apply(l, arguments) : void 0
                }
                "string" != typeof e && (i.guid = e.guid = e.guid || i.guid || f.guid++);
                var s = t.match(/^([\w:-]*)\s*(.*)$/),
                    o = s[1] + l.eventNamespace,
                    n = s[2];
                n ? a.on(o, n, i) : h.on(o, i)
            })
        },
        _off: function(t, e) {
        ...
        _trigger: function(t, e, i) {
            ...
            if (i = i || {}, (e = f.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), e.target = this.element[0], o = e.originalEvent)
                for (s in o) s in e || (e[s] = o[s]);
            return this.element.trigger(e, i), !(f.isFunction(n) && !1 === n.apply(this.element[0], [e].concat(i)) || e.isDefaultPrevented())
        }
    }, f.each({
        show: "fadeIn",
        hide: "fadeOut"
    }, function(n, r) {
        f.Widget.prototype["_" + n] = function(e, t, i) {
            "string" == typeof t && (t = {
                effect: t
            });
            var s, o = t ? !0 === t || "number" == typeof t ? r : t.effect || r : n;
            "number" == typeof(t = t || {}) && (t = {
                duration: t
            }), s = !f.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && f.effects && f.effects.effect[o] ? e[n](t) : o !== n && e[o] ? e[o](t.duration, t.easing, i) : e.queue(function(t) {
                f(this)[n](), i && i.call(e[0]), t()
            })
        }
        ...
        return "fixed" !== e && o.length ? o : f(this[0].ownerDocument || document)
    ...
    f(document).on("mouseup", function() {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(t) {
                ...
                return !0 === f.data(t.target, e.widgetName + ".preventClickEvent") ? (f.removeData(t.target, e.widgetName + ".preventClickEvent"), t.stopImmediatePropagation(), !1) : void 0
            }), this.started = !1
        },
        ...
        _mouseDown: function(t) {
            if (!n) {
                ...
                return i && !s && this._mouseCapture(t) && (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    e.mouseDelayMet = !0
                }, this.options.delay)), this._mouseDistanceMet(t) && this._mouseDelayMet(t) && (this._mouseStarted = !1 !== this._mouseStart(t), !this._mouseStarted) ? t.preventDefault() : (!0 === f.data(t.target, this.widgetName + ".preventClickEvent") && f.removeData(t.target, this.widgetName + ".preventClickEvent"), this._mouseMoveDelegate = function(t) {
        ...
        _mouseUp: function(t) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && f.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, n = !1, t.preventDefault()
        },
        ...
        _mouseCapture: function(t, e) {
            ...
            return !this.reverting && (!this.options.disabled && "static" !== this.options.type && (this._refreshItems(t), f(t.target).parents().each(function() {
                return f.data(this, o.widgetName + "-item") === o ? (i = f(this), !1) : void 0
            }), f.data(t.target, o.widgetName + "-item") === o && (i = f(t.target)), !!i && (!(this.options.handle && !e && (f(this.options.handle, i).find("*").addBack().each(function() {
                this === t.target && (s = !0)
        ...
        _mouseStart: function(t, e, i) {
            ...
            return f.ui.ddmanager && (f.ui.ddmanager.current = this), f.ui.ddmanager && !n.dropBehaviour && f.ui.ddmanager.prepareOffsets(this, t), this.dragging = !0, this._addClass(this.helper, "ui-sortable-helper"), this._mouseDrag(t), !0
        },
        _mouseDrag: function(t) {
            var e, i, s, o, n = this.options,
                r = !1;
            for (this.position = this._generatePosition(t), this.positionAbs = this._convertPositionTo("absolute"), this.lastPositionAbs || (this.lastPositionAbs = this.positionAbs), this.options.scroll && (this.scrollParent[0] !== this.document[0] && "HTML" !== this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < n.scrollSensitivity ? this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop + n.scrollSpeed : t.pageY - this.overflowOffset.top < n.scrollSensitivity && (this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop - n.scrollSpeed), this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < n.scrollSensitivity ? this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft + n.scrollSpeed : t.pageX - this.overflowOffset.left < n.scrollSensitivity && (this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft - n.scrollSpeed)) : (t.pageY - this.document.scrollTop() < n.scrollSensitivity ? r = this.document.scrollTop(this.document.scrollTop() - n.scrollSpeed) : this.window.height() - (t.pageY - this.document.scrollTop()) < n.scrollSensitivity && (r = this.document.scrollTop(this.document.scrollTop() + n.scrollSpeed)), t.pageX - this.document.scrollLeft() < n.scrollSensitivity ? r = this.document.scrollLeft(this.document.scrollLeft() - n.scrollSpeed) : this.window.width() - (t.pageX - this.document.scrollLeft()) < n.scrollSensitivity && (r = this.document.scrollLeft(this.document.scrollLeft() + n.scrollSpeed))), !1 !== r && f.ui.ddmanager && !n.dropBehaviour && f.ui.ddmanager.prepareOffsets(this, t)), this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), e = this.items.length - 1; 0 <= e; e--)
                if (s = (i = this.items[e]).item[0], (o = this._intersectsWithPointer(i)) && i.instance === this.currentContainer && s !== this.currentItem[0] && this.placeholder[1 === o ? "next" : "prev"]()[0] !== s && !f.contains(this.placeholder[0], s) && ("semi-dynamic" !== this.options.type || !f.contains(this.element[0], s))) {
            ...
            if (t) {
                if (f.ui.ddmanager && !this.options.dropBehaviour && f.ui.ddmanager.drop(this, t), this.options.revert) {
                    var i = this,
                        ...
                        o = this.options.axis,
                        n = {};
                    o && "x" !== o || (n.left = s.left - this.offset.parent.left - this.margins.left + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollLeft)), o && "y" !== o || (n.top = s.top - this.offset.parent.top - this.margins.top + (this.offsetParent[0] === this.document[0].body ? 0 : this.offsetParent[0].scrollTop)), this.reverting = !0, f(this.helper).animate(n, parseInt(this.options.revert, 10) || 500, function() {
                        i._clear(t)
                    })
        ...
        _intersectsWith: function(t) {
            var e = this.positionAbs.left,
                ...
                u = "x" === this.options.axis || h < s + l && s + l < a,
                p = "y" === this.options.axis || n < e + c && e + c < r,
                f = u && p;
        ...
        _getItemsAsjQuery: function(t) {
            ...
            if (a && t)
                for (i = a.length - 1; 0 <= i; i--)
                    for (s = (o = f(a[i], this.document[0])).length - 1; 0 <= s; s--)(n = f.data(o[s], this.widgetFullName)) && n !== this && !n.options.disabled && h.push([f.isFunction(n.options.items) ? n.options.items.call(n.element) : f(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), n]);
            for (h.push([f.isFunction(this.options.items) ? this.options.items.call(this.element, null, {
                    options: this.options,
                    item: this.currentItem
                }) : f(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), this]), i = h.length - 1; 0 <= i; i--) h[i][0].each(e);
            return f(r)
        },
        ...
        _refreshItems: function(t) {
            ...
            if (u && this.ready)
                for (e = u.length - 1; 0 <= e; e--)
                    for (i = (s = f(u[e], this.document[0])).length - 1; 0 <= i; i--)(o = f.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && (c.push([f.isFunction(o.options.items) ? o.options.items.call(o.element[0], t, {
                        item: this.currentItem
                    }) : f(o.options.items, o.element), o]), this.containers.push(o));
            for (e = c.length - 1; 0 <= e; e--)
                for (n = c[e][1], i = 0, a = (r = c[e][0]).length; i < a; i++)(h = f(r[i])).data(this.widgetName + "-item", n), l.push({
                    item: h,
                    instance: n,
                    width: 0,
                    height: 0,
        ...
        refreshPositions: function(t) {
            var e, i, s, o;
            for (this.floating = !!this.items.length && ("x" === this.options.axis || this._isFloating(this.items[0].item)), this.offsetParent && this.helper && (this.offset.parent = this._getParentOffset()), e = this.items.length - 1; 0 <= e; e--)(i = this.items[e]).instance !== this.currentContainer && this.currentContainer && i.item[0] !== this.currentItem[0] || (s = this.options.toleranceElement ? f(this.options.toleranceElement, i.item) : i.item, t || (i.width = s.outerWidth(), i.height = s.outerHeight()), o = s.offset(), i.left = o.left, i.top = o.top);
        ...
        _createPlaceholder: function(i) {
            ...
            }), i.placeholder = f(o.placeholder.element.call(i.element, i.currentItem)), i.currentItem.after(i.placeholder), o.placeholder.update(i, i.placeholder)
        },
        ...
        _contactContainers: function(t) {
            var e, i, s, o, n, r, h, a, l, c, u = null,
                p = null;
            for (e = this.containers.length - 1; 0 <= e; e--)
                if (!f.contains(this.currentItem[0], this.containers[e].element[0]))
                    if (this._intersectsWith(this.containers[e].containerCache)) {
                        if (u && f.contains(this.containers[e].element[0], u.element[0])) continue;
                        u = this.containers[e], p = e
            ...
            if (u)
                if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash(this)), this.containers[p].containerCache.over = 1);
                    ...
                    for (s = 1e4, o = null, n = (l = u.floating || this._isFloating(this.currentItem)) ? "left" : "top", r = l ? "width" : "height", c = l ? "pageX" : "pageY", i = this.items.length - 1; 0 <= i; i--) f.contains(this.containers[p].element[0], this.items[i].item[0]) && this.items[i].item[0] !== this.currentItem[0] && (h = this.items[i].item.offset()[n], a = !1, t[c] - h > this.items[i][r] / 2 && (a = !0), s > Math.abs(t[c] - h) && (s = Math.abs(t[c] - h), o = this.items[i], this.direction = a ? "up" : "down"));
        ...
        _generatePosition: function(t) {
            var e, i, s = this.options,
                o = t.pageX,
                n = t.pageY,
                r = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && f.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent,
            ...
            return "relative" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && this.scrollParent[0] !== this.offsetParent[0] || (this.offset.relative = this._getRelativeOffset()), this.originalPosition && (this.containment && (t.pageX - this.offset.click.left < this.containment[0] && (o = this.containment[0] + this.offset.click.left), t.pageY - this.offset.click.top < this.containment[1] && (n = this.containment[1] + this.offset.click.top), t.pageX - this.offset.click.left > this.containment[2] && (o = this.containment[2] + this.offset.click.left), t.pageY - this.offset.click.top > this.containment[3] && (n = this.containment[3] + this.offset.click.top)), s.grid && (e = this.originalPageY + Math.round((n - this.originalPageY) / s.grid[1]) * s.grid[1], n = this.containment ? e - this.offset.click.top >= this.containment[1] && e - this.offset.click.top <= this.containment[3] ? e : e - this.offset.click.top >= this.containment[1] ? e - s.grid[1] : e + s.grid[1] : e, i = this.originalPageX + Math.round((o - this.originalPageX) / s.grid[0]) * s.grid[0], o = this.containment ? i - this.offset.click.left >= this.containment[0] && i - this.offset.click.left <= this.containment[2] ? i : i - this.offset.click.left >= this.containment[0] ? i - s.grid[0] : i + s.grid[0] : i)), {
                top: n - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : h ? 0 : r.scrollTop()),
        ...
        _clear: function(t, e) {
            ...
            for (this.fromOutside && !e && o.push(function(t) {
                ...
                }.call(this, this.currentContainer)))), s = this.containers.length - 1; 0 <= s; s--) e || o.push(i("deactivate", this, this.containers[s])), this.containers[s].containerCache.over && (o.push(i("out", this, this.containers[s])), this.containers[s].containerCache.over = 0);
...
! function(t) {
    ...
    if (t.support.touch = "ontouchend" in document, t.support.touch) {
        var u, o = t.ui.mouse.prototype,
            n = o._mouseInit,
            c = o._mouseDestroy;
        o._touchStart = function(o) {
            !u && this._mouseCapture(o.originalEvent.changedTouches[0]) && (u = !0, this._touchMoved = !1, e(o, "mouseover"), e(o, "mousemove"), e(o, "mousedown"))
        }, o._touchMove = function(o) {
            u && (this._touchMoved = !0, e(o, "mousemove"))
        }, o._touchEnd = function(o) {
            u && (e(o, "mouseup"), e(o, "mouseout"), this._touchMoved || e(o, "click"), u = !1)
...
! function(e, t) {
    ...
    var C = {
        ...
        s = function(e) {
            ...
            for (var t, n, o = String(e), r = o.length, a = -1, i = "", c = o.charCodeAt(0); ++a < r;) {
                ...
                1 <= t && t <= 31 || 127 == t || 0 === a && 48 <= t && t <= 57 || 1 === a && 48 <= t && t <= 57 && 45 === c ? i += "\\" + t.toString(16) + " " : i += 128 <= t || 45 === t || 95 === t || 48 <= t && t <= 57 || 65 <= t && t <= 90 || 97 <= t && t <= 122 ? o.charAt(a) : "\\" + o.charAt(a)
            }
            try {
    ...
    return function(o, e) {
        ...
        O.cancelScroll = function(e) {
            cancelAnimationFrame(b), b = null, e || H("scrollCancel", y)
            ...
            if (u || t) {
                var l = I.pageYOffset;
                s.header && !S && (S = document.querySelector(s.header)), E || (E = A(S));
                var d, r, a, n, o, m = u ? i : function(e, t, n, o) {
                        var r = 0;
                        if (e.offsetParent)
                            for (; r += e.offsetTop, e = e.offsetParent;);
                        return r = Math.max(r - t - n, 0), o && (r = Math.min(r, L() - I.innerHeight)), r
                    }(t, E, parseInt("function" == typeof s.offset ? s.offset(i, c) : s.offset, 10), s.clip),
                    f = m - l,
                    h = L(),
                    p = 0,
                    g = function(e, t) {
                        var n, o, r, a = I.pageYOffset;
                        if (e == t || a == t || (l < t && I.innerHeight + a) >= h) return O.cancelScroll(!0), o = t, r = u, 0 === (n = i) && document.body.focus(), r || (n.focus(), document.activeElement !== n && (n.setAttribute("tabindex", "-1"), n.focus(), n.style.outline = "none"), I.scrollTo(0, o)), H("scrollStop", s, i, c), !(b = d = null)
                    },
                    v = function(e) {
                        var t, n, o;
                        d || (d = e), r = (p += e - d) / parseInt(s.speed, 10), a = l + f * (n = r = 1 < r ? 1 : r, "easeInQuad" === (t = s).easing && (o = n * n), "easeOutQuad" === t.easing && (o = n * (2 - n)), "easeInOutQuad" === t.easing && (o = n < .5 ? 2 * n * n : (4 - 2 * n) * n - 1), "easeInCubic" === t.easing && (o = n * n * n), "easeOutCubic" === t.easing && (o = --n * n * n + 1), "easeInOutCubic" === t.easing && (o = n < .5 ? 4 * n * n * n : (n - 1) * (2 * n - 2) * (2 * n - 2) + 1), "easeInQuart" === t.easing && (o = n * n * n * n), "easeOutQuart" === t.easing && (o = 1 - --n * n * n * n), "easeInOutQuart" === t.easing && (o = n < .5 ? 8 * n * n * n * n : 1 - 8 * --n * n * n * n), "easeInQuint" === t.easing && (o = n * n * n * n * n), "easeOutQuint" === t.easing && (o = 1 + --n * n * n * n * n), "easeInOutQuint" === t.easing && (o = n < .5 ? 16 * n * n * n * n * n : 1 + 16 * --n * n * n * n * n), t.customEasing && (o = t.customEasing(n)), o || n), I.scrollTo(0, Math.floor(a)), g(a, m) || (b = I.requestAnimationFrame(v), d = e)
                    };
                0 === I.pageYOffset && I.scrollTo(0, 0), n = i, o = s, u || history.pushState && o.updateURL && history.pushState({
                    smoothScroll: JSON.stringify(o),
                    anchor: n.id
                }, document.title, n === document.documentElement ? "#top" : "#" + n.id), H("scrollStart", s, i, c), O.cancelScroll(!0), I.requestAnimationFrame(v)
            }
        };
        var n = function(e) {
                if (!("matchMedia" in I && I.matchMedia("(prefers-reduced-motion)").matches) && 0 === e.button && !e.metaKey && !e.ctrlKey && "closest" in e.target && (r = e.target.closest(o)) && "a" === r.tagName.toLowerCase() && !e.target.closest(y.ignore) && r.hostname === I.location.hostname && r.pathname === I.location.pathname && /#/.test(r.href)) {
                    var t = s(c(r.hash)),
                        n = y.topOnEmptyHash && "#" === t ? document.documentElement : document.querySelector(t);
                    (n = n || "#top" !== t ? n : document.documentElement) && (e.preventDefault(), O.animateScroll(n, r))
                }
            },
            a = function(e) {
        ...
        return O.destroy = function() {
            y && (document.removeEventListener("click", n, !1), I.removeEventListener("resize", i, !1), I.removeEventListener("popstate", a, !1), O.cancelScroll(), b = t = E = S = r = y = null)
        }, O.init = function(e) {
            ...
            O.destroy(), y = w(C, e || {}), S = y.header ? document.querySelector(y.header) : null, E = A(S), document.addEventListener("click", n, !1), S && I.addEventListener("resize", i, !1), y.updateURL && y.popstate && I.addEventListener("popstate", a, !1)
        }, O.init(e), O
    }
});
! function(d) {
    ...
    function a(n) {
        n && 3 === n.which || (d(".dropdown-backdrop").remove(), d(i).each(function() {
            var t = d(this),
                e = s(t),
                o = {
                    relatedTarget: this
                };
            e.hasClass("open") && (n && "click" == n.type && /input|textarea/i.test(n.target.tagName) && d.contains(e[0], n.target) || (e.trigger(n = d.Event("hide.bs.dropdown", o)), n.isDefaultPrevented() || (t.attr("aria-expanded", "false"), e.removeClass("open").trigger(d.Event("hidden.bs.dropdown", o)))))
        }))
    }
    n.VERSION = "3.3.6", n.prototype.toggle = function(t) {
        ...
        if (!e.is(".disabled, :disabled")) {
            var o = s(e),
                n = o.hasClass("open");
            if (a(), !n) {
                "ontouchstart" in document.documentElement && !o.closest(".navbar-nav").length && d(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(d(this)).on("click", a);
                var r = {
                    relatedTarget: this
                };
                if (o.trigger(t = d.Event("show.bs.dropdown", r)), t.isDefaultPrevented()) return;
                e.trigger("focus").attr("aria-expanded", "true"), o.toggleClass("open").trigger(d.Event("shown.bs.dropdown", r))
            }
            return !1
        }
        ...
        if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName)) {
            ...
            if (t.preventDefault(), t.stopPropagation(), !e.is(".disabled, :disabled")) {
                var o = s(e),
                    n = o.hasClass("open");
                if (!n && 27 != t.which || n && 27 == t.which) return 27 == t.which && o.find(i).trigger("focus"), e.trigger("click");
